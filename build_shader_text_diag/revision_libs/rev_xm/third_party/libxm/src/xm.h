...
/* This should be 0 for Windows 98 builds or if you don't want to use CMake */ 
#define _XM_CMAKE 1 


/* To change macros and configure settings on Windows 98 projects, go to line 48. 
   For more information on the macros intended for users, check at the very bottom    */
...
#include <stddef.h>
    ...
    /* this is not intended to be used on a CMake project */

    #include <polyfill/msvc.h>

#else
    /* If you're using C89, or if your compiler doesn't have some C99 headers (like older msvc),
    make a polyfill for your compiler. Use code inside msvc_polyfill.h for basing your own 
    polyfill as needed. Make sure the polyfill doesn't define anything if definitions exist */
...
/* Put your constants from libxmize below if you are building for Windows 98.          */
    ...
    #define XM_PANNING_TYPE 8
    
    #define XM_SAMPLE_RATE 0
    
    #define XM_LINEAR_INTERPOLATION 1 
    #define XM_RAMPING 1 
    #define XM_LIBXM_DELTA_SAMPLES 1 
    #define XM_STRINGS 1 
    #define XM_TIMING_FUNCTIONS 1 
    #define XM_MUTING_FUNCTIONS 1 
    #define XM_MICROSTEP_BITS 12 
    ...
    /* end of (intended) modifiable macros */
...
/*
* xm_sample_type_t could be int8_t, int16_t or float.
* Without generics, you'd have to use #if _XM_typeof(XM_SAMPLE_TYPE) == _XM_type_typename
*/
 ...
 */
xm_context_t* xm_create_context(char* pool,
...
void xm_save_context(const xm_context_t*, char* out);
 ...
 */
void xm_generate_samples_noninterleaved(xm_context_t*, float * output_left, float * output_right, uint16_t numsamples);
 ...
 * @param numsamples number of samples to generate
 */
void xm_generate_samples_unmixed(xm_context_t*, float * output, uint16_t numsamples);
 ...
 */
xm_sample_point_t* xm_get_sample_waveform(xm_context_t*, uint16_t sample,  uint32_t* out_length);
 ...
 * generated audio)
 */
void xm_get_position(const xm_context_t*, uint8_t* pattern_index, uint8_t* pattern, uint8_t* row, uint32_t* samples);
 ...
 *
 * Modified from the Artefact2's so it outputs macros for use.
 * 
 * @param out Should point to a writeable area, at least XM_ANALYZE_OUTPUT_SIZE
 * bytes long. */
void xm_analyze(xm_context_t*, char* out);
...
/*
* XM_VERBOSE - Print informational messages to stderr.
* 0 -> disabled
* 1 -> enabled
* Default: 1
*
*
* XM_LINEAR_INTERPOLATION - Use linear interpolation (FT2-like, CPU hungry).
* 0 -> disabled
* 1 -> enabled
* Default: 1
*
*
* XM_RAMPING - Enable ramping (FT2-like, CPU hungry)
* 0 -> disabled
* 1 -> enabled
* Default: 1
*
*
* XM_LIBXM_DELTA_SAMPLES - Delta-code samples in libxm format (may improve compressibility, but adds some code size)
* 0 -> disabled
* 1 -> enabled
* Default: 0
*
*
* XM_STRINGS - "Store module, instrument and sample names in context"
* 0 -> disabled
* 1 -> enabled
* Default: 1
*
*
* XM_TIMING_FUNCTIONS - "Enable xm_latest_trigger_of_*() functions for instruments, samples and channels"
* 0 -> disabled
* 1 -> enabled
* Default: 1
*
* XM_MUTING_FUNCTIONS - "Enable xm_mute_*() functions for instruments and channels"
* 0 -> disabled
* 1 -> enabled
* Default: 1
*
*
*
* XM_SAMPLE_TYPE "Sample type of internal PCM samples (int8_t,int16_t,float)", default: int16_t)
* To choose, set the XM_SAMPLE_TYPE to one of these values
* 
* float
* int8_t
* int16_t
...
*
*
* XM_SAMPLE_RATE - Output sample rate. It should fit within a uint16_t var
* 0            -> Configurable via xm_set_sample_rate()
* other values -> Hardcoded, e.g. 44100 or 48000.
* Default: 0
*
*
* XM_MICROSTEP_BITS - Precision of sample stepping
* From 8 to 12 inclusive.
* Higher = better pitch accuracy, lower = can load larger samples.
* Default: 12
*
*
* XM_LOOPING_TYPE - Looping type
* 0 -> loop forever
* 1 -> Loop once
* 2 -> Runtime based via xm_set_max_loop_count()
* Default: 2
*
*
*
* Values found via xm_analyze are recommended to define these macros below
*
* XM_DISABLED_EFFECTS - "Bit mask of effects to disable, see xm_internal.h for EFFECT_ constants"
* Default: 0
*
* XM_DISABLED_VOLUME_EFFECTS - "Bit mask of volume effects to disable, see xm_internal.h for VOLUME_EFFECT_ constants"
* Default: 0
*
* XM_DISABLED_FEATURES - "Bit mask of features to disable, see xm_internal.h for FEATURE_ constants"
* Default: 0
*
* XM_PANNING_TYPE - "Panning type (0=Mono, 1..7=Hard Amiga panning, 8=Full stereo panning, 9=Default ST3 panning)"
* Default: 0
*
*
*
