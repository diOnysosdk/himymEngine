...
// Uncomment these includes once ImGui is added:
// #include "imgui.h"
...
EditorContext* CreateEditor(rev::platform::Window* window) {
    ...
    // Initialize ImGui (requires imgui.h)
    // IMGUI_CHECKVERSION();
    // ImGui::CreateContext();
...
void DestroyEditor(EditorContext* editor) {
    ...
    // Cleanup ImGui (requires imgui.h)
...
void BeginFrame(EditorContext* editor) {
    ...
    // ImGui frame start (requires imgui.h)
...
void EndFrame(EditorContext* editor) {
    ...
    // ImGui frame end and render (requires imgui.h)
    // ImGui::Render();
...
void RenderMenuBar(EditorContext* editor) {
    ...
    // ImGui menu bar (requires imgui.h)
...
void RenderTimeline(EditorContext* editor) {
    ...
    // ImGui timeline window (requires imgui.h)
...
void RenderCurveEditor(EditorContext* editor) {
    ...
    // ImGui curve editor window (requires imgui.h)
...
void RenderShaderModal(EditorContext* editor) {
    ...
    // ImGui shader modal (requires imgui.h)
